...
import com.chat.repository.neo4j.ConversationNodeRepository;
...
public class Neo4jService {
    ...
    // 构造函数注入 Neo4jClient
    public Neo4jService(ConversationNodeRepository conversationNodeRepository, Neo4jClient neo4jClient) {
        this.conversationNodeRepository = conversationNodeRepository;
